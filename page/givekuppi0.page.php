...
if ($_SESSION['regNum']) {
    ...
    <div class="kuppi-div">
        <form action="givekuppi0.page.php" method="post" class="kuppi">
            ...
            <div class="dd"><textarea name="kuppidesc" id="" cols="30" rows="5" placeholder="Description"></textarea></div>
    ...
    if (isset($_POST['kuppiback'])) {
        echo "<script>";
        echo "window.location.href = 'givekuppi.page.php';";
        echo "</script>";
        exit();
    }
    if (isset($_POST['kuppishare'])) {
        ...
        if (empty($ktitle) || empty($kdesc) || empty($kcode)) {
            ...
            $sql = "INSERT INTO give_kuppi_details (regNum, kuppicoz, kuppititle, kuppidesc, getkey) VALUES (?, ?, ?, ?, ?)";
            ...
            if (mysqli_stmt_prepare($stmt, $sql)) {
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    updateHistory($con, $reg . " published a give kuppi post.Good work!!!");
